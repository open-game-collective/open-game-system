...
- `npx storybook@latest automigrate --config-dir apps/web/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir games/codebreakers/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir games/diffusionary/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir games/little-vigilante/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir games/sailors/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir games/trivia-jam/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir libs/components/.storybook --renderer @storybook/react`
